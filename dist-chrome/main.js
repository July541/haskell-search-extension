"use strict";
(() => {
  // extension/Omnibox/hackageData.ts
  var HackageData = class {
    name;
    description;
  ...
  var hackageRawData = [
    ...
    ["bytestring", "bytestring description"],
    ["text", "text description"],
    ["vector", "vector description"]
  ];
  var hackageData = hackageRawData.map(([name, description]) => new HackageData(name, description));
